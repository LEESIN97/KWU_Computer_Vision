...
public:
    ...
    void setupUi(QDialog *MainFrame)
    {
        ...
        pushOstu = new QPushButton(tab_1);
        pushOstu->setObjectName("pushOstu");
        pushOstu->setGeometry(QRect(50, 20, 171, 31));
        label = new QLabel(tab_1);
        label->setObjectName("label");
        label->setGeometry(QRect(50, 60, 61, 31));
        spinOstu = new QSpinBox(tab_1);
        spinOstu->setObjectName("spinOstu");
        spinOstu->setGeometry(QRect(120, 60, 42, 31));
        spinOstu->setMinimum(1);
        spinOstu->setMaximum(254);
        spinOstu->setValue(100);
        pushThresholding = new QPushButton(tab_1);
        pushThresholding->setObjectName("pushThresholding");
        pushThresholding->setGeometry(QRect(180, 60, 41, 31));
        label_2 = new QLabel(tab_1);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(30, 120, 101, 31));
        editKernelSize = new QLineEdit(tab_1);
        editKernelSize->setObjectName("editKernelSize");
        editKernelSize->setGeometry(QRect(180, 120, 41, 31));
        pushDilation = new QPushButton(tab_1);
        pushDilation->setObjectName("pushDilation");
        pushDilation->setGeometry(QRect(20, 170, 101, 41));
        pushErosion = new QPushButton(tab_1);
        pushErosion->setObjectName("pushErosion");
        pushErosion->setGeometry(QRect(150, 170, 101, 41));
        pushLabeling = new QPushButton(tab_1);
        pushLabeling->setObjectName("pushLabeling");
        pushLabeling->setGeometry(QRect(40, 230, 171, 61));
        label_3 = new QLabel(tab_1);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(0, 300, 151, 31));
        editNeighborType = new QLineEdit(tab_1);
        editNeighborType->setObjectName("editNeighborType");
        editNeighborType->setGeometry(QRect(180, 310, 20, 21));
    ...
    void retranslateUi(QDialog *MainFrame)
    {
        ...
        label_2->setText(QCoreApplication::translate("MainFrame", "Kernel Size(3 or 5)", nullptr));
        ...
        pushLabeling->setText(QCoreApplication::translate("MainFrame", "Labeling", nullptr));
        label_3->setText(QCoreApplication::translate("MainFrame", "Neighbor Type(4-N or 8-N)", nullptr));
