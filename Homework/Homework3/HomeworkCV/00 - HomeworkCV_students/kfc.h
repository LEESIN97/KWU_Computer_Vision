...
//    void         IntegralImage2(KArrayDWord& arInt, KArrayDWord& arIntSquare) const;
    ...
    KImageGray   BinaryDilate(const int& nType, const int& KernelSize);
    KImageGray   BinaryErode(const int& nType, const int& KernelSize);
    KImageColor  Labeling(const int& NeighborType, int& NLabel);
