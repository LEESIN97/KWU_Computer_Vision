...
public:
    ...
    explicit ImageForm(const KArray<KHSI>& arHSI, const QString& q_stID, MainFrame* owner, const char& image_type, const QString& q_stAtrb="HSV");
    explicit ImageForm(const KArray<KNRG>& arNRG, const QString& q_stID, MainFrame* owner, const char& image_type, const QString& q_stAtrb="NRG");
