...
public:
    ...
    QWidget *tab_1;
    QPushButton *pushRGB2HSI;
    QPushButton *pushRGB2NRG;
    QWidget *tab_4;
    QWidget *tab_5;
    QWidget *tab_2;
    ...
    void setupUi(QDialog *MainFrame)
    {
        ...
        pushRGB2HSI = new QPushButton(tab_1);
        pushRGB2HSI->setObjectName("pushRGB2HSI");
        pushRGB2HSI->setGeometry(QRect(80, 30, 80, 24));
        pushRGB2NRG = new QPushButton(tab_1);
        pushRGB2NRG->setObjectName("pushRGB2NRG");
        pushRGB2NRG->setGeometry(QRect(80, 90, 80, 24));
    ...
    void retranslateUi(QDialog *MainFrame)
    {
        ...
        pushRGB2HSI->setText(QCoreApplication::translate("MainFrame", "pushRGB2HSI", nullptr));
        pushRGB2NRG->setText(QCoreApplication::translate("MainFrame", "pushRGB2NRG", nullptr));
