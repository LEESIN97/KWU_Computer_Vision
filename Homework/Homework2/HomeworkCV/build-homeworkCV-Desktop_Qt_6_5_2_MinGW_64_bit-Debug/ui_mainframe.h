...
public:
    ...
    QLabel *label;
    QLabel *label_2;
    QSpinBox *spinIntensityOutputLower;
    QSpinBox *spinIntersityOutputUpper;
    QLabel *label_3;
    QLabel *label_4;
    QSpinBox *spinInternsityInputLower;
    QSpinBox *spinIntensityInputUpper;
    QPushButton *pushLuminanceColorTransform;
    QWidget *tab_4;
    QWidget *tab_5;
    QWidget *tab_2;
    ...
    void setupUi(QDialog *MainFrame)
    {
        ...
        label_2->setGeometry(QRect(160, 130, 50, 16));
        spinIntensityOutputLower = new QSpinBox(tab_1);
        spinIntensityOutputLower->setObjectName("spinIntensityOutputLower");
        spinIntensityOutputLower->setGeometry(QRect(70, 130, 42, 25));
        spinIntensityOutputLower->setMaximum(255);
        spinIntersityOutputUpper = new QSpinBox(tab_1);
        spinIntersityOutputUpper->setObjectName("spinIntersityOutputUpper");
        spinIntersityOutputUpper->setGeometry(QRect(210, 130, 42, 25));
        spinIntersityOutputUpper->setMaximum(255);
        spinIntersityOutputUpper->setValue(255);
        label_3 = new QLabel(tab_1);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(30, 100, 50, 16));
        label_4 = new QLabel(tab_1);
        label_4->setObjectName("label_4");
        label_4->setGeometry(QRect(160, 100, 50, 16));
        spinInternsityInputLower = new QSpinBox(tab_1);
        spinInternsityInputLower->setObjectName("spinInternsityInputLower");
        spinInternsityInputLower->setGeometry(QRect(70, 100, 42, 25));
        spinInternsityInputLower->setMaximum(255);
        spinInternsityInputLower->setValue(100);
        spinIntensityInputUpper = new QSpinBox(tab_1);
        spinIntensityInputUpper->setObjectName("spinIntensityInputUpper");
        spinIntensityInputUpper->setGeometry(QRect(210, 100, 42, 25));
        spinIntensityInputUpper->setMaximum(255);
        spinIntensityInputUpper->setValue(150);
        pushLuminanceColorTransform = new QPushButton(tab_1);
        pushLuminanceColorTransform->setObjectName("pushLuminanceColorTransform");
        pushLuminanceColorTransform->setGeometry(QRect(60, 40, 181, 41));
    ...
    void retranslateUi(QDialog *MainFrame)
    {
        ...
        label_3->setText(QCoreApplication::translate("MainFrame", "a", nullptr));
        label_4->setText(QCoreApplication::translate("MainFrame", "b", nullptr));
        pushLuminanceColorTransform->setText(QCoreApplication::translate("MainFrame", "Luminance Contrast Transform", nullptr));
