...
//    void         IntegralImage2(KArrayDWord& arInt, KArrayDWord& arIntSquare) const;
    ...
    KImageGray   BinaryOpening(const int& nType, const int& KernelSize);
    KImageGray   BinaryClosing(const int& nType, const int& KernelSize);
    KImageGray   BoundaryExtractor(const int& BoundaryType, const int& NeighborType);
