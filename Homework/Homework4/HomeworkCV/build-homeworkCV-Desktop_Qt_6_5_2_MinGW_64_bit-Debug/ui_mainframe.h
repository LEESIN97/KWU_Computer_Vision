...
public:
    ...
    QWidget *tab_1;
    QLabel *label;
    QLineEdit *editKernelSize;
    QPushButton *pushOpening;
    QPushButton *pushClosing;
    QPushButton *pushOtsuThresholding;
    QPushButton *pushBoundaryExtractor;
    QLabel *label_2;
    QLabel *label_3;
    QLineEdit *editBoundaryType;
    QLineEdit *editNeighborType;
    QWidget *tab_4;
    QWidget *tab_5;
    QWidget *tab_2;
    ...
    void setupUi(QDialog *MainFrame)
    {
        ...
        editKernelSize = new QLineEdit(tab_1);
        editKernelSize->setObjectName("editKernelSize");
        editKernelSize->setGeometry(QRect(140, 70, 21, 24));
        pushOpening = new QPushButton(tab_1);
        pushOpening->setObjectName("pushOpening");
        pushOpening->setGeometry(QRect(20, 120, 111, 51));
        pushClosing = new QPushButton(tab_1);
        pushClosing->setObjectName("pushClosing");
        pushClosing->setGeometry(QRect(150, 120, 111, 51));
        pushOtsuThresholding = new QPushButton(tab_1);
        pushOtsuThresholding->setObjectName("pushOtsuThresholding");
        pushOtsuThresholding->setGeometry(QRect(80, 10, 131, 41));
        pushBoundaryExtractor = new QPushButton(tab_1);
        pushBoundaryExtractor->setObjectName("pushBoundaryExtractor");
        pushBoundaryExtractor->setGeometry(QRect(90, 210, 111, 51));
        label_2 = new QLabel(tab_1);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(10, 280, 171, 20));
        label_3 = new QLabel(tab_1);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(0, 320, 221, 20));
        editBoundaryType = new QLineEdit(tab_1);
        editBoundaryType->setObjectName("editBoundaryType");
        editBoundaryType->setGeometry(QRect(240, 320, 16, 24));
        editNeighborType = new QLineEdit(tab_1);
        editNeighborType->setObjectName("editNeighborType");
        editNeighborType->setGeometry(QRect(190, 280, 21, 24));
    ...
    void retranslateUi(QDialog *MainFrame)
    {
        ...
        label->setText(QCoreApplication::translate("MainFrame", "Kernel Size(3 or 5) :", nullptr));
        editKernelSize->setText(QCoreApplication::translate("MainFrame", "3", nullptr));
        ...
        pushOtsuThresholding->setText(QCoreApplication::translate("MainFrame", "Otsu Thresholding", nullptr));
        pushBoundaryExtractor->setText(QCoreApplication::translate("MainFrame", "Boundary Extractor", nullptr));
        label_2->setText(QCoreApplication::translate("MainFrame", "Neighborhood Mask(b4 or b8)", nullptr));
        label_3->setText(QCoreApplication::translate("MainFrame", "Type (foreground : 1, background : 2)", nullptr));
        editBoundaryType->setText(QCoreApplication::translate("MainFrame", "1", nullptr));
        editNeighborType->setText(QCoreApplication::translate("MainFrame", "4", nullptr));
